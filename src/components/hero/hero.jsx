...
const hero = () => {
  const handleRegisterClick = () => {
    ...
    window.open("https://docs.google.com/forms/d/1w5FJGxRQMzQzsQfv5pdwMeTjhdAggSKzZ-j6tcOvGQA/viewform?edit_requested=true");
  };
  ...
  const handleCountdown = () => {
    const countDate = new Date("February 21, 2025 09:00:00").getTime();
    ...
    <React.Fragment>
        ...
        <div className=" tag-hero-mobile">
          ...
          <div className="tag">
              ...
              <div> SRM VALLIAMMAI ENGINEERING COLLEGE</div>
        ...
        <section className="column">
          ...
          <div className="right_side">
            ...
            <div className="col3 animated-div">
              ...
              <p className="text8" align = "center">
                Open to all domains
              </p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col "
               onClick={() =>
                window.open("https://srmvalliammai.ac.in/")
              }>
            ...
            <div className="col6 animated-div">
              ...
              <div className="flex items-start justify-between flex-col"
               onClick={() =>
                window.open("https://whitehatians.in/")
              }>
                <p className="text14"> </p>
