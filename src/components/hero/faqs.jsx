      ...
      <div id="faqs" className="parent-faqs">
        ...
        <div className="faqs-section">
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              Hack-A-Tank_2.0 is the first 24-hour national-level hackathon
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              Hack-A-Tank_2.0 is open to all undergraduate students from all
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              ...
              registration fee of Rs. 599/- per team, which includes GST. It
          ...
          <div className="faqs-content" onClick={handleArrow}>
            ...
            <p className="faqs-content-description">
              The event has a prize pool of Rs 22,500 for the winners.
            </p>
          </div>
          <div className="faqs-content" onClick={handleArrow}>
            <h1 className="faqs-content-title">
              What is the team size to participate in the Hack-A-Tank_2.0?
              <ChevronRightIcon
                style={styles.container}
                className="faqs-arrow"
              />
